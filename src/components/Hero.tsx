...
import { Star, CheckCircle, Flame, Clock, Check, Gift } from "lucide-react";
    ...
    <section id="inicio" className="container max-w-6xl mx-auto py-12 md:py-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div className="order-2 md:order-1 text-center md:text-left">
          ...
          {/* Gift Display */}
          {selectedKit.gift && (
            <div className="mt-6 bg-green-50 border border-dashed border-green-300 rounded-lg p-4">
                <div className="flex items-center gap-3">
                    <Gift className="h-6 w-6 text-green-600" />
                    <p className="text-green-800 font-semibold">
                        Brinde Exclusivo: <span className="font-normal">{selectedKit.gift}</span>
                    </p>
                </div>
            </div>
          )}
